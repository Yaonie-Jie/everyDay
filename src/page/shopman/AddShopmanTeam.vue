<template>
  <div id="box">
    <div class="add_team">
      ...
      <div class="add_this_teamer"><el-button type="primary" size="small" @click="addTeamli">添加其做团长</el-button></div>
        ...
        this.$http.post(url,data).then(
          function(res){
            if(res.body.result){
              ...
              let data=res.body.data.memberManage
