      ...
      <div class="contents">
        ...
        <div class="item2">
          <el-table border style="max-width:900px;margin:0 auto;" :data="tableData">
            <el-table-column prop="account" label="账号（手机号）" :span='3' align="center"
                             header-align="center"></el-table-column>
            <el-table-column prop="createOn" label="注册时间" align="center" :span='2'
                             header-align="center"></el-table-column>
            <el-table-column prop="loginTime" label="上次登录时间" align="center" :span='3'
                             header-align="center"></el-table-column>
